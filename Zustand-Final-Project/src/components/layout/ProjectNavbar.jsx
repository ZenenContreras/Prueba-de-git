...
function ProjectNavbar () {
    ...
    const proyectCount = useProjectStore((state)=> state.projects.length)
    ...
    return (
        <nav className='max-w-screen flex justify-between p-6 border-b border-gray-700'>
            <div className='flex flex-col '>
                ...
                <h3 className='text-sm text-gray-500'>Managing <strong>{proyectCount}</strong> ongoing proyects</h3>
            </div>
